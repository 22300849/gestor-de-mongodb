...
namespace NotasApp
{
    public partial class MainForm : Form
    {
        ...
        // Paleta de colores cafés elegantes y cálidos
        private readonly Color backgroundColor = Color.FromArgb(245, 240, 230);      // Fondo beige claro cálido
        private readonly Color panelColor = Color.FromArgb(250, 245, 235);           // Paneles beige muy claro
        private readonly Color cardColor = Color.FromArgb(255, 250, 240);            // Tarjetas de notas blanco hueso
        private readonly Color primaryColor = Color.FromArgb(160, 110, 80);          // Café medio elegante
        private readonly Color accentColor = Color.FromArgb(140, 90, 60);            // Café más oscuro
        private readonly Color borderColor = Color.FromArgb(245, 240, 230);          // Bordes beige medio
        private readonly Color textColor = Color.FromArgb(80, 60, 50);               // Texto café oscuro
        private readonly Color lightTextColor = Color.FromArgb(130, 110, 100);       // Texto café medio
        private readonly Color hoverColor = Color.FromArgb(235, 225, 210);           // Hover estado beige cálido
        private readonly Color selectedColor = Color.FromArgb(240, 230, 215);        // Seleccionado beige dorado
        ...
        private void CreateEditorPanel(TableLayoutPanel parent)
        {
            ...
            btnEliminar = CreateModernButton("ELIMINAR", Color.Transparent, Color.FromArgb(180, 100, 80), new Point(240, 0));
            btnEliminar.Size = new Size(100, 45);
            btnEliminar.FlatAppearance.BorderColor = Color.FromArgb(180, 100, 80);
        ...
        private Button CreateModernButton(string text, Color backColor, Color foreColor, Point location)
        {
            ...
            button.MouseEnter += (s, e) =>
            {
                if (backColor == Color.Transparent)
                    button.BackColor = Color.FromArgb(235, 225, 210);
                else
            ...
            {
                if (backColor == Color.Transparent)
                    button.BackColor = Color.FromArgb(225, 215, 200);
                else
